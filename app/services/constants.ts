...
const classicComparison = {
  ...
  columns: [
    ...
    { key: "smile", title: "SMILE", subtitle: "Flapless Laser", image: "/assets/smile1.png", values: ["Suitable candidates wanting a flapless laser option", "Laser removes a small lenticule through a tiny incision", "Recovery varies", "May reduce glasses dependence", "Often considered in selected cases", "No", "Yes"] },
    { key: "prk", title: "PRK", subtitle: "Surface Laser", image: "/assets/prk1.png", values: ["Thin cornea / selected cases", "Surface laser treatment without a corneal flap", "Recovery varies, typically slower than LASIK/SMILE", "May reduce glasses dependence", "Depends on eye condition", "No", "Yes"] },
