  ...
  useEffect(() => {
    ...
    async function doVerify() {
      try {
        ...
        const res = await fetch(`${baseUrl}${prefix}/public/newsletter/verify`, {
          method: "POST",
        ...
        if (res.ok && json?.success) {
          setStatus("success");
          setMessage(json.message || "Your newsletter subscription has been confirmed successfully!");
        } else {
          setStatus("error");
    ...
    <div style={{ maxWidth: "600px", margin: "120px auto 80px", padding: "40px 24px", textAlign: "center" }}>
      {status === "loading" ? (
        <div>
          ...
          <h1 style={{ fontSize: "24px", fontWeight: "800" }}>Confirming your subscription...</h1>
        </div>
      ) : null}
      ...
      {status === "success" ? (
        <div>
          ...
          <h1 style={{ fontSize: "28px", fontWeight: "800", marginBottom: "12px", color: "#0f1117" }}>Subscription Confirmed!</h1>
          ...
          <Link
            ...
            style={{
              ...
              padding: "12px 28px",
              borderRadius: "999px",
              background: "linear-gradient(135deg, #1fc6df, #2f73f5)",
              color: "#fff",
              fontWeight: "700",
              textDecoration: "none",
            }}
      ...
      {status === "error" ? (
        <div>
          ...
          <h1 style={{ fontSize: "28px", fontWeight: "800", marginBottom: "12px", color: "#0f1117" }}>Verification Failed</h1>
          <p style={{ color: "#687080", fontSize: "16px", marginBottom: "28px" }}>{message}</p>
          <Link
            href="/"
            style={{
