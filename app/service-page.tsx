...
const cataractLensComparison = [
  {
    ...
    popular: false,
    values: ["Excellent", "Needs glasses", "Limited", "No", "Usually needed", "Minimal risk", "Usually covered", "Budget conscious; happy to wear glasses"],
  },
  {
    key: "edof",
    title: "EDOF IOL",
    subtitle: "Extended Depth of Focus",
    image: "/assets/enhanced-monofocal.png",
    popular: false,
    values: ["Excellent", "Needs glasses", "Clear", "In toric variants", "Reduced dependency", "Minimal glare & halos", "Premium lens option", "Distance-to-intermediate clarity"],
  },
  {
    key: "toric",
    title: "Toric",
    ...
    popular: false,
    values: ["Excellent", "Needs glasses", "Limited", "Yes", "Reduced need", "Minimal risk", "~ Partial coverage", "Patients with astigmatism"],
  },
  {
    key: "trifocal",
    ...
    popular: true,
    values: ["Excellent", "Clear", "Clear", "~ Varies", "Rarely needed", "~ Brief adjustment", "Premium", "Spectacle-free living"],
  },
];
  ...
  return (
    <>
      ...
      <main className={`service-page ${config.kind}`}>
        ...
        <AppointmentSection withForm={false} kind={config.kind} image={["lasik", "glaucoma", "squint", "keratoconus"].includes(config.kind) ? "/assets/lasik/vision_journey.jpeg" : config.kind === "retina" ? "/assets/retina-chair.webp" : "/assets/cataract-chair.webp"} />
      </main>
      <Footer home />
    </>
  );
